...
topper1=np.argmax(a[:,3])
print("Roll no who got maximum marks in Subject 3", a[topper1,0])

# 14. print Roll number who got minimum marks in Subject 2
topper2=np.argmin(a[:,2])
print("Roll no who got minimum marks in Subject 2",a[topper2,0])
...
less=np.sum(a[:,1]<40)
print("Count of students who got marks in Subject 1 < 40",less)

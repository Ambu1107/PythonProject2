...
plt.stackplot(df['Month'],df['City_A_Temperature'],df['City_B_Temperature'],df['City_C_Temperature'],labels=['City_A_Temperature','City_B_Temperature','City_C_Temperature'])
